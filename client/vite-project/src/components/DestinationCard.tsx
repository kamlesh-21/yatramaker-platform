...
import { getDestinationAffiliateLink, trackAffiliateClick } from "@/utils/affiliateLinks";
    ...
    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group h-full flex flex-col">
      ...
      <div className="flex-1 p-3 flex flex-col justify-between gap-2">
        ...
        <div className="flex flex-col gap-2 mt-auto">
          {/* Primary: Explore - filled, prominent */}
          <Button
            onClick={onClick}
          ...
          {/* Secondary: Book Hotels - hover reveal, outline style */}
          <div className="relative">
            <Button
              ...
              <a
                href={getDestinationAffiliateLink(data, searchData)}
                target="_blank"
