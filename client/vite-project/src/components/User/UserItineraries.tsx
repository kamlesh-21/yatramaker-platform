// // // // client/vite-project/src/components/User/UserItineraries.tsx
...
// import { Loader2, MoreVertical, Trash2, Edit, Heart, MapPin, Calendar, Users, Building, Tag } from 'lucide-react';
...
//       // console.log('ITINERARIES ARRAY →', response.itineraries);

//       // if (response.itineraries?.length > 0) {
//       //   console.log('FIRST ITINERARY →', response.itineraries[0]);
//       // }
...
//       setError(null);
//     } catch (err: any) {
//       setError(err.response?.data?.msg || 'Error fetching itineraries');
...
// //     console.log('SINGLE DEST REC →', it.singleDestinationRecommendation);
// //     console.log('MULTI CITY REC →', it.multiCityRecommendation);

// //     if (it.singleDestinationRecommendation) {
// //       console.log('DESTINATION FIELD →', it.singleDestinationRecommendation.destination);
// //       console.log('DESTINATION TYPE →', typeof it.singleDestinationRecommendation.destination);
// //     }
// //   }
// // }, [itineraries]);
...
//       setDeleteId(null);
//     } catch (err: any) {
//       setError(err.response?.data?.msg || 'Error deleting itinerary');
...
//       );
//     } catch (err: any) {
//       setError(err.response?.data?.msg || 'Error updating favorite');
//     }
//   };

//   // Get itinerary name based on type
// // In UserItineraries.tsx, update the getItineraryName function:
...
//       // Structure 1: rec.destination exists
//       if (rec.destination) {
...
//       // Structure 2: rec has name property directly
//       if (rec.name) {
//         return Array.isArray(rec.name) ? rec.name[0] : rec.name;
//       }
      
//       // Structure 3: rec has itineraryName
//       if (rec.itineraryName) {
//         return rec.itineraryName;
//       }
      
//       // Structure 4: rec.destination is a string
...
//   // Fallback to notes or created date
//   if (itinerary.notes) {
...
// // Also update the getDestinationDetails function:
...
//       }
//     } else {
//       // If rec itself is the destination
//       destinationInfo = {
...
//     const rec = itinerary.multiCityRecommendation;
//     return {
//       destinations: Array.isArray(rec.name) ? rec.name : [],
//       totalCost: rec.totalCost || itinerary.budget
//     };
//   };
...
//                           onClick={() => {
//                             if (isSingle) {
//                               // For single destination, navigate to a single destination detail view
//                               navigate(`/saved-destination/${itinerary._id}`, { 
//                                 state: { 
//                                   itinerary,
//                                   destination: itinerary.singleDestinationRecommendation 
//                                 } 
...
const handleViewDetails = (itinerary: Itinerary) => {
  ...
  console.log('Navigating with:', {
    ...
    isSingle,
    isMulti,
    hasSingleData: !!itinerary.singleDestinationRecommendation,
    hasMultiData: !!itinerary.multiCityRecommendation
  });
